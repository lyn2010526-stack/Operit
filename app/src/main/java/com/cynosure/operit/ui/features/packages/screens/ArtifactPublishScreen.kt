...
import com.cynosure.operit.ui.features.packages.market.isOperit2VersionAllowed
import com.cynosure.operit.ui.features.packages.market.sameArtifactRuntimePackageId
import com.cynosure.operit.ui.features.packages.screens.artifact.viewmodel.ArtifactMarketViewModel
...
private fun com.cynosure.operit.data.api.MarketV2Entry.toArtifactPublishEditInfo(): ArtifactPublishEditInfo {
...
fun com.cynosure.operit.data.api.MarketV2Entry.toArtifactPublishClusterContext(): ArtifactPublishClusterContext {
    val versionValue = latestVersion
...
fun ArtifactPublishScreen(
    onNavigateBack: () -> Unit,
    editingEntry: com.cynosure.operit.data.api.MarketV2Entry? = null,
