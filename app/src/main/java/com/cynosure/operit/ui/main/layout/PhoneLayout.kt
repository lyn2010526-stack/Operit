package com.cynosure.operit.ui.main.layout
...
import com.cynosure.operit.ui.main.NavigationTransitionSource
import com.cynosure.operit.ui.main.TopBarTitleContent
import com.cynosure.operit.ui.main.navigation.NavigationEntrySpec
import com.cynosure.operit.ui.main.navigation.RouteEntry
import com.cynosure.operit.ui.main.components.AppContent
import com.cynosure.operit.ui.main.components.DrawerContent
import com.cynosure.operit.ui.main.components.rememberNavigationDrawerAppearance
...
fun PhoneLayout(
        ...
        val isAnimating =
            drawerState.currentValue != DrawerValue.Closed && drawerState.targetValue != drawerState.currentValue
                ...
                Surface(
                        modifier =
                                Modifier.width(drawerWidth)
                                        ...
                                        .waterGlass(
                                                enabled = drawerAppearance.waterGlassEnabled && !isAnimating,
                                                shape = drawerShape,
                        ...
                        shape = drawerShape,
                        color =
                                if (drawerAppearance.waterGlassEnabled && !isAnimating) Color.Transparent
                                else drawerAppearance.containerColor,
                        shadowElevation = if (drawerAppearance.waterGlassEnabled && !isAnimating) 0.dp else sidebarElevation
                ) {
                        DrawerContent(
                                navItems = navItems,
