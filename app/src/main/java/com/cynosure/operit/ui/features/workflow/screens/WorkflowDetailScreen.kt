package com.cynosure.operit.ui.features.workflow.screens
...
import com.cynosure.operit.ui.features.workflow.components.ConnectionMenuDialog
import com.cynosure.operit.ui.features.workflow.components.NodeActionMenuDialog
import com.cynosure.operit.ui.features.workflow.components.ScheduleConfigDialog
...
fun NodeDialog(
    ...
    val initialActionConfigPairs = if (node is ExecuteNode) {
        node.actionConfig.map { (key, paramValue) ->
            when (paramValue) {
                is com.cynosure.operit.data.model.ParameterValue.StaticValue -> 
                    ParameterConfig(key, false, paramValue.value)
                is com.cynosure.operit.data.model.ParameterValue.NodeReference -> 
