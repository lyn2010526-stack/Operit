package com.cynosure.operit.ui.features.demo.viewmodel
...
import com.cynosure.operit.ui.features.demo.state.DemoStateManager
...
class ShizukuDemoViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val uiState: StateFlow<com.cynosure.operit.ui.features.demo.state.DemoScreenState> =
