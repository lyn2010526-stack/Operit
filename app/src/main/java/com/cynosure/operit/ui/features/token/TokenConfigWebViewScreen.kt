...
import com.cynosure.operit.ui.features.token.components.UrlConfigDialog
import com.cynosure.operit.ui.features.token.model.NavDestination
import com.cynosure.operit.ui.features.token.model.getIconForIndex
import com.cynosure.operit.ui.features.token.preferences.UrlConfigManager
...
fun TokenConfigWebViewScreen(onNavigateBack: () -> Unit) {
    ...
    // 获取URL配置
    val urlConfig by urlConfigManager.urlConfigFlow.collectAsState(initial = com.cynosure.operit.ui.features.token.model.UrlConfig())
