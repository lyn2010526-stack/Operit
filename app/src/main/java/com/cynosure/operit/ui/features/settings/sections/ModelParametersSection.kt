...
import com.cynosure.operit.data.model.StandardModelParameters
...
fun ModelParametersSection(
        ...
        if (config.hasCustomParameters &&
            ...
            try {
                ...
                val customParamsList =
                    json.decodeFromString<List<com.cynosure.operit.data.model.CustomParameterData>>(
                        config.customParameters
                    )
    ...
    // 状态
    var parameterToEdit by remember { mutableStateOf<com.cynosure.operit.data.model.CustomParameterData?>(null) }
...
private fun convertCustomParameterDataToModelParameter(
    customParam: com.cynosure.operit.data.model.CustomParameterData
): ModelParameter<*> {
...
): com.cynosure.operit.data.model.CustomParameterData {
    return com.cynosure.operit.data.model.CustomParameterData(
        id = param.id,
        name = param.name,
...
private fun AddCustomParameterDialog(
    onDismiss: () -> Unit,
    onSave: (com.cynosure.operit.data.model.CustomParameterData) -> Unit,
    existingParam: com.cynosure.operit.data.model.CustomParameterData? = null
) {
