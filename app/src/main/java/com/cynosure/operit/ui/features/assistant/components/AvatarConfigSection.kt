package com.cynosure.operit.ui.features.assistant.components
...
import com.cynosure.operit.core.avatar.common.state.AvatarMoodTypeDefinition
...
@Composable
fun ModelSelector(
    models: List<com.cynosure.operit.data.repository.AvatarConfig>,
