...
import com.cynosure.operit.core.tools.packTool.TOOLPKG_EVENT_AI_PROVIDER_CALCULATE_INPUT_TOKENS
import com.cynosure.operit.core.tools.packTool.TOOLPKG_EVENT_AI_PROVIDER_LIST_MODELS
import com.cynosure.operit.core.tools.packTool.TOOLPKG_EVENT_AI_PROVIDER_SEND_MESSAGE
import com.cynosure.operit.core.tools.packTool.TOOLPKG_EVENT_AI_PROVIDER_TEST_CONNECTION
...
import com.cynosure.operit.plugins.toolpkg.ToolPkgAiProviderRegistration
import com.cynosure.operit.plugins.toolpkg.decodeToolPkgHookResult
import com.cynosure.operit.plugins.toolpkg.jsonObjectToMap
import com.cynosure.operit.plugins.toolpkg.toolPkgPackageManager
...
internal class ToolPkgJsAiProviderService(
    ...
    override suspend fun sendMessage(
        ...
        enableRetry: Boolean
    ): Stream<String> = com.cynosure.operit.util.stream.stream {
