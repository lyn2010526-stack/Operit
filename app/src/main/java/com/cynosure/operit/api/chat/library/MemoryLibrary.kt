package com.cynosure.operit.api.chat.library
...
object MemoryLibrary {
    ...
    private fun buildPreferencesText(context: Context, profile: com.cynosure.operit.data.model.PreferenceProfile): String {
