...
import com.cynosure.operit.data.model.ModelOption
...
import com.cynosure.operit.api.chat.llmprovider.EndpointCompleter
...
import com.cynosure.operit.util.HttpLogSanitizer
import com.cynosure.operit.util.LocaleUtils
import com.cynosure.operit.util.StreamingJsonXmlConverter
import com.cynosure.operit.util.TokenCacheManager
import com.cynosure.operit.util.exceptions.UserCancellationException
...
open class OpenAIProvider(
        ...
        for (param in modelParameters) {
            if (param.isEnabled) {
                ...
                when (param.valueType) {
                    com.cynosure.operit.data.model.ParameterValueType.INT ->
                        jsonObject.put(mappedApiName, param.currentValue as Int)

                    com.cynosure.operit.data.model.ParameterValueType.FLOAT ->
                        jsonObject.put(mappedApiName, param.currentValue as Float)

                    com.cynosure.operit.data.model.ParameterValueType.STRING ->
                        jsonObject.put(mappedApiName, param.currentValue as String)

                    com.cynosure.operit.data.model.ParameterValueType.BOOLEAN ->
                        jsonObject.put(mappedApiName, param.currentValue as Boolean)

                    com.cynosure.operit.data.model.ParameterValueType.OBJECT -> {
     ...
     * 从结构化参数构建JSON Schema
     */
    private fun buildSchemaFromStructured(params: List<com.cynosure.operit.data.model.ToolParameterSchema>): JSONObject {
    ...
    private inner class StreamEmitter(
        ...
        private val eventChannel: com.cynosure.operit.util.stream.MutableSharedStream<TextStreamEvent>,
