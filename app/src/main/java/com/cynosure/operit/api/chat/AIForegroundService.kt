...
import com.cynosure.operit.api.speech.PersonalWakeListener
import com.cynosure.operit.api.speech.SpeechPrerollStore
import com.cynosure.operit.api.speech.SpeechService
...
import com.cynosure.operit.core.application.ForegroundServiceCompat
import com.cynosure.operit.data.preferences.ExternalHttpApiConfig
...
import com.cynosure.operit.integrations.http.ExternalChatHttpServer
import com.cynosure.operit.integrations.http.ExternalChatHttpState
import com.cynosure.operit.services.FloatingChatService
import com.cynosure.operit.services.UIDebuggerService
...
class AIForegroundService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_CANCEL_CURRENT_OPERATION = "com.cynosure.operit.action.CANCEL_CURRENT_OPERATION"
        private const val REQUEST_CODE_CANCEL_CURRENT_OPERATION = 9002

        private const val ACTION_EXIT_APP = "com.cynosure.operit.action.EXIT_APP"
        private const val REQUEST_CODE_EXIT_APP = 9003

        private const val ACTION_TOGGLE_WAKE_LISTENING = "com.cynosure.operit.action.TOGGLE_WAKE_LISTENING"
        ...
        private const val ACTION_SET_WAKE_LISTENING_SUSPENDED_FOR_IME =
            "com.cynosure.operit.action.SET_WAKE_LISTENING_SUSPENDED_FOR_IME"
        ...
        private const val ACTION_SET_WAKE_LISTENING_SUSPENDED_FOR_FLOATING_FULLSCREEN =
            "com.cynosure.operit.action.SET_WAKE_LISTENING_SUSPENDED_FOR_FLOATING_FULLSCREEN"
        private const val EXTRA_FLOATING_FULLSCREEN_ACTIVE = "extra_floating_fullscreen_active"

        const val ACTION_PREPARE_WAKE_HANDOFF =
            "com.cynosure.operit.action.PREPARE_WAKE_HANDOFF"

        private const val ACTION_ENSURE_MICROPHONE_FOREGROUND =
            "com.cynosure.operit.action.ENSURE_MICROPHONE_FOREGROUND"
        private const val ACTION_START_OR_REFRESH_EXTERNAL_HTTP =
            "com.cynosure.operit.action.START_OR_REFRESH_EXTERNAL_HTTP"
        private const val ACTION_STOP_EXTERNAL_HTTP =
            "com.cynosure.operit.action.STOP_EXTERNAL_HTTP"
    ...
    private fun triggerWakeLaunch() {
        ...
        try {
            val floatingIntent = Intent(this, FloatingChatService::class.java).apply {
                putExtra("INITIAL_MODE", com.cynosure.operit.ui.floating.FloatingMode.FULLSCREEN.name)
