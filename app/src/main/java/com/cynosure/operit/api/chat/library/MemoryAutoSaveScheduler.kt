...
import com.cynosure.operit.data.model.MemoryAutoSaveCandidate
...
class MemoryAutoSaveScheduler(
    ...
    private suspend fun processChatCandidateGroup(
        ...
        messageDao: com.cynosure.operit.data.dao.MessageDao,
        toolHandler: AIToolHandler,
        memoryService: com.cynosure.operit.api.chat.llmprovider.AIService
    ) {
