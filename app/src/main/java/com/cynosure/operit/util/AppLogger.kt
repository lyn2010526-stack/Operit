...
/**
 * App-wide logger with an API closely mirroring [com.cynosure.operit.util.AppLogger].
 *
...
object AppLogger {
    ...
    // Mirror com.cynosure.operit.util.AppLogger priority constants
    ...
    // --- Public API mirroring com.cynosure.operit.util.AppLogger ---
