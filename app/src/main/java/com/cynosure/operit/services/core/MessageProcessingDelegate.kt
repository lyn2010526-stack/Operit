...
import com.cynosure.operit.core.tools.agent.PhoneAgentJobRegistry
import com.cynosure.operit.data.model.*
import com.cynosure.operit.data.model.InputProcessingState as EnhancedInputProcessingState
            ...
            try {
                ...
                val (provider, modelName) = try {
                    service.getDisplayProviderAndModelForFunction(
                        functionType = com.cynosure.operit.data.model.FunctionType.CHAT,
                        chatModelConfigIdOverride = chatModelConfigIdOverride,
                        chatModelIndexOverride = chatModelIndexOverride
                    )
                } catch (e: Exception) {
