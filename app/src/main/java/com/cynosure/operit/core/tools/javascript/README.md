...
```js
Java.loadDex('/data/user/<current_user_id>/com.cynosure.operit/files/plugins/demo.dex');
...
```js
Java.loadJar('/data/user/<current_user_id>/com.cynosure.operit/files/plugins/demo.jar');
...
```js
Java.loadDex('/data/user/<current_user_id>/com.cynosure.operit/files/plugins/demo.dex', {
  nativeLibraryDir: '/data/user/<current_user_id>/com.cynosure.operit/files/plugins/lib'
});
```
