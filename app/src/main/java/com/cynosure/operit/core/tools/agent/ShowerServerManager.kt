...
import com.cynosure.showerclient.ShowerServerManager as CoreShowerServerManager
 ...
 *   CLASSPATH=/data/user/<current_user_id>/<pkg>/files/shower-server.jar app_process / com.cynosure.shower.Main
 */
