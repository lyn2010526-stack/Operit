package com.cynosure.operit.core.application
...
import com.cynosure.operit.BuildConfig
...
import com.cynosure.operit.plugins.PluginRegistry
import com.cynosure.operit.plugins.lifecycle.AppLifecycleEvent
import com.cynosure.operit.plugins.lifecycle.AppLifecycleHookParams
import com.cynosure.operit.plugins.lifecycle.AppLifecycleHookPluginRegistry
...
import com.cynosure.operit.core.workflow.WorkflowSchedulerInitializer
...
import com.cynosure.operit.data.preferences.initAndroidPermissionPreferences
import com.cynosure.operit.data.preferences.initUserPreferencesManager
...
import com.cynosure.operit.ui.features.chat.webview.workspace.editor.language.LanguageFactory
import com.cynosure.operit.util.GlobalExceptionHandler
...
import com.cynosure.operit.util.CrashRecoveryState
import com.cynosure.operit.util.OperitPaths
import com.cynosure.operit.util.SkillRepoZipPoolManager
import com.cynosure.operit.util.SerializationSetup
import com.cynosure.operit.util.TextSegmenter
import com.cynosure.operit.util.WaifuMessageProcessor
import com.cynosure.operit.core.tools.agent.ShowerController
import com.cynosure.operit.ui.common.displays.VirtualDisplayOverlay
import com.tom_roush.pdfbox.android.PDFBoxResourceLoader
import com.cynosure.operit.core.tools.system.shower.OperitShowerShellRunner
import com.cynosure.showerclient.ShowerEnvironment
import com.cynosure.showerclient.ShowerLogSink
import java.io.File
...
class OperitApplication : Application(), ImageLoaderFactory, WorkConfiguration.Provider {
    ...
    private fun initializeMainApplicationLocked() {
        ...
        applicationScope.launch(Dispatchers.Default) {
            ...
            DiagnosticsRegistry.initialize(this@OperitApplication, toolHandler)
        ...
        applicationScope.launch {
            ...
            try {
                val bound = com.cynosure.operit.data.repository.UIHierarchyManager.bindToService(this@OperitApplication)
