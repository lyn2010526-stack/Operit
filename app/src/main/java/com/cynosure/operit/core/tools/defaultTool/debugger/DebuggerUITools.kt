...
import com.cynosure.operit.core.tools.UIActionResultData
import com.cynosure.operit.core.tools.UIPageResultData
import com.cynosure.operit.core.tools.defaultTool.accessbility.AccessibilityUITools
            ...
            try {
                ...
                val tapTool =
                        AITool(
                                ...
                                parameters =
                                        listOf(
                                                com.cynosure.operit.data.model.ToolParameter(
                                                        "x",
                                                        centerX.toString()
                                                ),
                                                com.cynosure.operit.data.model.ToolParameter(
