...
import com.cynosure.operit.ui.features.chat.webview.workspace.process.WorkspaceRuleFileReader
  ...
  suspend fun getSystemPrompt(
    ...
    val skillPackages = try {
        SkillRepository.getInstance(
            com.cynosure.operit.core.application.OperitApplication.instance.applicationContext
