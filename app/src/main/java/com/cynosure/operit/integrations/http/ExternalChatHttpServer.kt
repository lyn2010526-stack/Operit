...
import com.cynosure.operit.integrations.externalchat.ExternalChatAcceptedResponse
import com.cynosure.operit.integrations.externalchat.ExternalChatHealthResponse
import com.cynosure.operit.integrations.externalchat.ExternalChatHttpRequest
import com.cynosure.operit.integrations.externalchat.ExternalChatRequestExecutor
import com.cynosure.operit.integrations.externalchat.ExternalChatResponseMode
import com.cynosure.operit.integrations.externalchat.ExternalChatResponseSanitizer
import com.cynosure.operit.integrations.externalchat.ExternalChatResult
import com.cynosure.operit.integrations.externalchat.ExternalChatStreamEnvelope
import com.cynosure.operit.integrations.externalchat.ExternalChatStreamingStartResult
...
class ExternalChatHttpServer(
    ...
    private fun sseResponse(request: ExternalChatHttpRequest, resolvedRequestId: String): Response {
        ...
        val streamingSessionRef =
            AtomicReference<com.cynosure.operit.integrations.externalchat.ExternalChatStreamingSession?>(
                null
            )
