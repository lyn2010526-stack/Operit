...
import com.cynosure.operit.data.model.CustomParameterData
...
import com.cynosure.operit.data.model.ApiKeyInfo
...
class ModelConfigManager(private val context: Context) {
    ...
    suspend fun updateModelConfig(
            ...
            apiEndpoint: String,
            modelName: String,
            apiProviderType: com.cynosure.operit.data.model.ApiProviderType,
...
private fun ModelParameter<*>.toCustomParameterData(): com.cynosure.operit.data.model.CustomParameterData {
