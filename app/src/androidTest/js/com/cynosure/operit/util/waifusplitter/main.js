...
function getWaifuMessageProcessorInstance() {
  return Java.type('com.cynosure.operit.util.WaifuMessageProcessor').INSTANCE;
}

function getStreamingSessionClass() {
  return Java.type('com.cynosure.operit.util.WaifuMessageProcessor$StreamingSession');
}
