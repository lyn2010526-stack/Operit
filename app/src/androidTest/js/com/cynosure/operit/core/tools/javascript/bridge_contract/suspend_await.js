...
const AndroidShellExecutor = Java.com.cynosure.operit.core.tools.system.AndroidShellExecutor;
const StandardActionListener = Java.com.cynosure.operit.core.tools.system.action.StandardActionListener;
const StreamBuildersKt = Java.type('com.cynosure.operit.util.stream.StreamBuildersKt');
...
function assertCommandResultProxy(result, label) {
  ...
  assertEq(
    ...
    'com.cynosure.operit.core.tools.system.AndroidShellExecutor$CommandResult',
  ...
  return runSuite([
    test('Java.callSuspend awaits companion suspend method and returns proxy result', async () => {
      const result = await withTimeout(
        Java.callSuspend(
          'com.cynosure.operit.core.tools.system.AndroidShellExecutor',
          'executeShellCommand',
    ...
    test('instance proxy callSuspend rejects with explicit message for missing suspend methods', async () => {
      ...
      assert(
        message.indexOf(
          "instance suspend method 'missingSuspendMethod' not found on com.cynosure.operit.core.tools.system.action.StandardActionListener"
        ) >= 0,
