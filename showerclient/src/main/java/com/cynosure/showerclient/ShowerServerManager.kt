package com.cynosure.showerclient
...
object ShowerServerManager {
    ...
    suspend fun ensureServerStarted(context: Context): Boolean {
        ...
        val killCmd = "pkill -f com.cynosure.shower.Main || true"
        ...
        val startCmd = "CLASSPATH=$remoteJarPath app_process / com.cynosure.shower.Main $targetPackagesArg &"
    ...
    suspend fun stopServer(): Boolean {
        ...
        val cmd = "pkill -f com.cynosure.shower.Main || true"
