...
import com.cynosure.shower.shell.FakeContext;
import com.cynosure.shower.shell.Workarounds;
import com.cynosure.shower.wrappers.ServiceManager;
import com.cynosure.shower.wrappers.WindowManager;
...
public class Main {
    ...
    private static final String ACTION_SHOWER_BINDER_READY = "com.cynosure.operit.action.SHOWER_BINDER_READY";
    ...
    private void launchPackageOnVirtualDisplay(String packageName, int displayId) {
        ...
        try {
            ...
            com.cynosure.shower.wrappers.ActivityManager am = ServiceManager.getActivityManager();
